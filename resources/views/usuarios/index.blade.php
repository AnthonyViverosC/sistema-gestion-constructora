...
<div class="space-y-8">
                <div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_420px] gap-8">
                    <div class="bg-white rounded-xl border border-primary/10 shadow-sm overflow-hidden">
                        ...
                        @php $filtros = $filtros ?? ['q' => '', 'rol' => '']; @endphp
                        <form method="GET" action="{{ route('usuarios.index') }}" id="usuariosFiltroForm"
                            ...
                            <div class="flex-1 relative">
                                ...
                                <input type="search" name="q" id="usuariosFiltroQ" value="{{ $filtros['q'] }}"
                                    ...
                                    class="w-full pl-9 pr-9 py-2.5 text-sm border border-primary/10 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-white">
                            ...
                            <select name="rol" id="usuariosFiltroRol"
                                class="sm:w-44 py-2.5 px-3 text-sm border border-primary/10 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-white">
                            ...
                            <div class="flex gap-2">
                                ...
                                @if ($filtros['q'] !== '' || $filtros['rol'] !== '')
                                    <a href="{{ route('usuarios.index') }}"
                                        class="px-4 py-2.5 rounded-lg border border-primary/10 text-primary/70 text-sm font-semibold hover:bg-primary/5 transition-colors">
                                        Limpiar
                                    </a>
                                @endif
                            </div>
                    ...
                    <form action="{{ $editando ? route('usuarios.update', $usuario) : route('usuarios.store') }}" method="POST"
                        ...
                        <div class="px-6 py-5 border-b border-primary/10 flex items-start justify-between gap-4">
                            ...
                            @if ($editando)
                                <a href="{{ route('usuarios.index', array_filter($filtros)) }}" class="text-xs font-bold text-primary/60 hover:text-primary">Cancelar</a>
                            @endif
                        </div>

...
<body class="bg-background-light font-display text-slate-900 antialiased min-h-screen">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col overflow-hidden min-w-0">
            <div class="lg:hidden flex items-center justify-between px-4 h-[var(--topbar-h)] bg-white border-b border-primary/10 sticky top-0 z-20">
            ...
            <header class="flex items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6 bg-white border-b border-primary/10">
                @yield('header')
            </header>
